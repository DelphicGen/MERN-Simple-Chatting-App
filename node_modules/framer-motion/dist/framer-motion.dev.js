(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var clampProgress$2 = /*#__PURE__*/clamp$1$1(0, 1);
    var tween = function (props) {
        ...
        return action(function (_a) {
            ...
            var updateTween = function () {
                currentProgress = clampProgress$2(progress(0, duration, elapsed));
    ...
    var transitionOptionParser = {
        ...
        keyframes: function (_a) {
            ...
            if (opts.values && opts.values[0] === null) {
                var values = __spread(opts.values);
                values[0] = from;
                opts.values = values;
            }
            if (opts.ease) {
    ...
    function startAnimation(key, value, target, _a) {
        ...
        return value.start(function (complete) {
            var activeAnimation;
            var _a = __read(getAnimation(key, value, target, transition), 2), animationFactory = _a[0], _b = _a[1], valueDelay = _b.delay, options = __rest(_b, ["delay"]);
        ...
        VisualElementAnimationControls.prototype.animateVariant = function (variantLabel, opts) {
            ...
            if (when) {
                var _a = __read(when === "beforeChildren"
                    ...
                    : [getChildrenAnimations, getAnimations], 2), first = _a[0], last = _a[1];
