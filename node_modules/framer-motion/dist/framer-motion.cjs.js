...
function applyAxisTransforms(final, axis, transforms, _a) {
    ...
    var originPoint = popcorn.mix(axis.min, axis.max, axisOrigin);
...
var transitionOptionParser = {
    ...
    keyframes: function (_a) {
        ...
        if (opts.values && opts.values[0] === null) {
            var values = tslib.__spread(opts.values);
            values[0] = from;
            opts.values = values;
        }
        if (opts.ease) {
...
function startAnimation(key, value, target, _a) {
    ...
    return value.start(function (complete) {
        var activeAnimation;
        var _a = tslib.__read(getAnimation(key, value, target, transition), 2), animationFactory = _a[0], _b = _a[1], valueDelay = _b.delay, options = tslib.__rest(_b, ["delay"]);
